...
const AllRoom = () => {
  ...
  const matchesRoomType = (room) => {
    return (
      ...
      selectedFilters.roomType.some(
        type => type.toLowerCase() === room.roomType?.trim().toLowerCase()
      )
    )
  }
  ...
  const filterDestination = (room) => {
    ...
    return room.hotel.city.toLowerCase().includes(
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='md:w-1/2 flex flex-col gap-2'>
              ...
              <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                ...
                {room.amenities.map((item, index) => (
                  <div
                    key={index}
                    className='flex items-center gap-4 px-3 py-2 rounded-lg bg-[#F5F5FF]/70'
                  >
      ...
      <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16'>
        ...
        <div
          className={`flex items-center justify-between px-5 py-2.5 lg:border-gray-300 ${
